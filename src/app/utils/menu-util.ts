...
export class MenuUtil {
  public static determineSelectedMenusForThisRole(
    role: RoleDto,
  ...
  public static getAllMenus(): MenuOptions[] {
    ...
    roleMenus.push({
      key: 1,
      value: 'wl.users',
      route: '/home/list-user',
      matIcon: 'supervised_user_circle',
    });
    roleMenus.push({
      key: 2,
      value: 'wl.roles',
      route: '/home/list-role',
      matIcon: 'person_pin',
    });
    ...
    roleMenus.push({
      key: 4,
      value: 'wl.groups',
      route: '/home/list-group',
      matIcon: 'groups',
    });
    roleMenus.push({
      key: 5,
      value: 'wl.disciplines',
      route: '/home/list-discipline',
      matIcon: 'book',
    });
    roleMenus.push({
      key: 6,
      value: 'wl.schedule',
      route: '/home/list-schedule',
      matIcon: 'events',
    });
    return roleMenus;
  }
